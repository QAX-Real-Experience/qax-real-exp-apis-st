package com.qaxpert.steps.register;
...
import com.qaxpert.utils.RegisterDataFactory;
...
public class RegisterSteps {
    ...
    public void registrarUsuarioSatisfactoriamente(){
        registerRequest = RegisterDataFactory.registerANewUserSuccessfully();
    }
    ...
    public void registrarUserConDatosIncompletosOInvalidos(
            ...
            String country,
            String whatsapp){
        String finalEmail = email.equalsIgnoreCase("random")
                ? RegisterDataFactory.generateRandomEmail()
                : email;
        registerRequest = RegisterDataFactory.customRegisterUser(
                finalEmail,
                password,
                fullname,
                country,
    ...
    public void registerAnExistentUser(){
        registerRequest = RegisterDataFactory.registerAUserWithExistingEmail();
    }
